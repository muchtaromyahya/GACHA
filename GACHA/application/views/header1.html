...
<link rel="stylesheet" type="text/css" href="assets/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="assets/bootstrap/css/bootstrap.min">
  <link rel="stylesheet" type="text/css" href="assets/bootstrap/css/bootstrap-grid">
  <link rel="stylesheet" type="text/css" href="assets/bootstrap/css/bootstrap-grid.min">
  <link rel="stylesheet" type="text/css" href="assets/bootstrap/css/bootstrap-reboot">
  <link rel="stylesheet" type="text/css" href="assets/bootstrap/css/bootstrap-reboot.min">
...
<body>
    <div class = "jumbotron" style = "margin-bottom: 0px;">
        <h1>Start Using GACHA Today!</h1>
        <p>Discover best job based on your experiences through GACHA</p>
    </div>
    ...
    <nav class = "navbar navbar-expand-md navbar-light bg-light sticky-top">
        ...
        <a class = "navbar-brand"><img src = "assets/placeholder.jpg" style = "width: 40px;height: 20%;"></a>
        <span class = "navbar-text" style = "padding-bottom:10px;margin-right: 580px;color: black;font-size: 25x;font-weight: bold;">GACHA</span>
            ...
            <ul class = "navbar-nav">
                ...
                <li class = "nav-item dropdown" >
                    <button class="nav-link dropdown-toggle login" data-toggle = "dropdown" data-target="dropdown_target1" style = "background:red;color:white;border:none;cursor:pointer;width: 75px;height:50px;border-radius:20px;padding-bottom:10px;">
                        Login
                    </button>
    ...
    <img src ="assets/placeholder_bg.png"> <!-- Place holder doang, diganti nanti kalo mau, mengecek apakah Navbar sticky atau tidak. Scroll kebawah nanti -->
