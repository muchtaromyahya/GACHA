...
<head>
    ...
    <title>GACHA</title>
    <link href = "<?php echo base_url('assets/logo_gacha2.png') ?>" rel="icon" type="image/png">
...
<body >
    <nav class = "navbar-nav navbar-expand-lg navbar-dark bg-dark sticky-top" style="padding:10px;">
        ...
        <a class = "navbar-brand" href="<?php echo base_url('Home'); ?>"><img src = "<?php echo base_url('assets/logo_gacha.png') ?>" style = "width: 100px"></a>
        <span class = "navbar-text" style = "padding-bottom:10px;margin-right: 580px;color: black;font-size: 25x;font-weight: bold;"></span>
