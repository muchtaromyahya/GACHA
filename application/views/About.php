    ...
    <footer class="page-footer font-small indigo" style = "background-color:grey;opacity:0.8;margin-top:200px;">
      ...
      <div class="row pb-2">
        ...
        <div class="col-md-1 col-lg-2 text-center justify-content-center mx-auto my-2" style="display:flex;align-items:center;justify-items:center;">
            ...
            <a>
              <img src = "<?php echo base_url('application/views/assets/facebook.png'); ?>" style="cursor:pointer;width:60px;margin-right:20px;" href='#'> 
            </a> 
            <a >
               <img src = "<?php echo base_url('application/views/assets/twitter.png'); ?>" style="cursor:pointer;width:60px;margin-right:20px;" href='#'> 
            </a>  
            <a >
              <img src = "<?php echo base_url('application/views/assets/whatsapp.png'); ?>" style="cursor:pointer;width:60px;margin-right:20px;" href='#'> 
            </a>
            <a>
               <img src = "<?php echo base_url('application/views/assets/instagram.png'); ?>" style="cursor:pointer;width:60px;margin-right:20px;" href='#'> 
            </a>
